...
class Video extends Model
{
    ...
    const THUMB_FILE_SIZE = 1024 * 5;
    const BANNER_FILE_SIZE = 1024 * 10;
    const TRAILER_FILE_SIZE = 1024 * 1024;
    const VIDEO_FILE_SIZE = 1024 * 1024  * 50;
    ...
    public function getThumbBannerUrlAttribute() {
