import { MuiDataTableRefComponent } from './../components/Table/index';
...
interface ExtraFilter {
    ...
    formatSearchParam: (debouncedState: FilterState) => any,
...
export class FilterManager {
    ...
    changeRowsPerPage(perPage) {
        this.dispatch(Creators.setPerPage({perPage: perPage + 1}));
    }

    columnSortChange(changedColumn: string, direction: string) {
    ...
    private formatSearchParams() {
        ...
        return {
            ...
            ...(
                this.extraFilter && this.extraFilter.formatSearchParam(this.debouncedState)
            )
        }
    }
